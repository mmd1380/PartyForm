<template>
  <v-expansion-panels v-model="open" multiple focusable>
    <v-expansion-panel dir="ltr" v-if="section === 'main'">
    ...
    <v-expansion-panel dir="ltr"  v-else-if="section === 'complement'">
      <v-expansion-panel-header style="text-align: right; direction: rtl">
        <template v-slot:default="{ open }">
          <v-row>
            <v-col
    ...
    <v-expansion-panel dir="ltr" v-else-if="section === 'communicate'">
      <v-expansion-panel-header style="text-align: right; direction: rtl">
    ...
    <v-expansion-panel dir="ltr" v-else-if="section === 'address'">
      <v-expansion-panel-header style="text-align: right; direction: rtl">
        <template>
          <v-row>
            <v-col
